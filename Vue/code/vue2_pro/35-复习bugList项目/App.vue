<template>
    <div> 
        ...
        <!-- 全局事件总线 -->
        <BugHeader @saveBugCallBack="saveBugCallBack"/>
        <BugList :bugList="bugList" v-show="isShow" @selectAllCallBack="selectAllCallBack" :selectedCount="selectedCount"/>
        <BugFooter v-show="isShow" @clearSelectedCallBack="clearSelectedCallBack" :bugList="bugList" :selectedCount="selectedCount"/>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                bugList: [
                    {id: '001', desc: 'bug001', selected: true},
                    {id: '002', desc: 'bug002', selected: false},
                    {id: '003', desc: 'bug003', selected: false}
                ]
            }
        },
        mounted(){
